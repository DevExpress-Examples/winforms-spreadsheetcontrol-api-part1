...
'#Region "Actions"
        Public UseConstantsAndCalculationOperatorsInFormulasAction As Action(Of IWorkbook) = AddressOf UseConstantsAndCalculationOperatorsInFormulas

        Public R1C1ReferencesInFormulassAction As Action(Of IWorkbook) = AddressOf R1C1ReferencesInFormulas

        Public UseNamesInFormulasAction As Action(Of IWorkbook) = AddressOf UseNamesInFormulas

        Public CreateNamedFormulasAction As Action(Of IWorkbook) = AddressOf CreateNamedFormulas

        Public UseFunctionsInFormulasAction As Action(Of IWorkbook) = AddressOf UseFunctionsInFormulas

        Public CreateSharedAndArrayFormulasAction As Action(Of IWorkbook) = AddressOf CreateSharedAndArrayFormulas

'#End Region
        Private Sub UseConstantsAndCalculationOperatorsInFormulas(ByVal workbook As IWorkbook)
            ...
            Try
                ...
                worksheet.Range("A1:B2").Alignment.Horizontal = HorizontalAlignment.Center
...
'#End Region  ' #ConstantsAndCalculationOperators
        ...
        Private Sub R1C1ReferencesInFormulas(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
                Dim worksheet As Worksheet = workbook.Worksheets(0)
                ' Provide static data.
...
'#End Region  ' #R1C1ReferencesInFormulas
        ...
        Private Sub UseNamesInFormulas(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
                Dim worksheet As Worksheet = workbook.Worksheets(0)
...
'#End Region  ' #NamesInFormulas
        ...
        Private Sub CreateNamedFormulas(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
...
'#End Region  ' #NamedFormulas
        ...
        Private Sub UseFunctionsInFormulas(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
                Dim worksheet As Worksheet = workbook.Worksheets(0)
                ' Provide static data.
...
'#End Region  ' #FunctionsInFormulas
        ...
        Private Sub CreateSharedAndArrayFormulas(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
                Dim worksheet As Worksheet = workbook.Worksheets(0)
