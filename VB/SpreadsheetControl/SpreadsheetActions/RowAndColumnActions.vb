...
'#Region "Actions"
        Public InsertRowsColumnsAction As Action(Of IWorkbook) = AddressOf InsertRowsColumns

        Public DeleteRowsColumnsAction As Action(Of IWorkbook) = AddressOf DeleteRowsColumns

        Public CopyRowsColumnsAction As Action(Of IWorkbook) = AddressOf CopyRowsColumns

        Public ShowHideRowsColumnsAction As Action(Of IWorkbook) = AddressOf ShowHideRowsColumns

        Public SpecifyRowsHeightColumnsWidthAction As Action(Of IWorkbook) = AddressOf SpecifyRowsHeightColumnsWidth

'#End Region
        Private Sub InsertRowsColumns(ByVal workbook As IWorkbook)
...
'#End Region  ' #InsertColumns
        ...
        Private Sub DeleteRowsColumns(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
...
'#End Region  ' #DeleteColumns
        ...
        Private Sub CopyRowsColumns(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
                Dim worksheet As Worksheet = workbook.Worksheets(0)
                ' Modify the 2nd row. 
                ...
                worksheet.Rows("2").Alignment.Vertical = VerticalAlignment.Center
...
'#End Region  ' #CopyRowsColumns
        ...
        Private Sub ShowHideRowsColumns(ByVal workbook As IWorkbook)
...
'#End Region  ' #ShowHideRowsColumns
        ...
        Private Sub SpecifyRowsHeightColumnsWidth(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
                Dim worksheet As Worksheet = workbook.Worksheets(0)
                worksheet.Range("B1:J1").Alignment.Horizontal = HorizontalAlignment.Center
                ...
                rowHeightValues.Alignment.Vertical = VerticalAlignment.Center
                rowHeightValues.Alignment.Horizontal = HorizontalAlignment.Center
