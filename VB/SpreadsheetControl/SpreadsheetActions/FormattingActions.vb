		...
		Private Shared Sub CustomNumberFormat(ByVal workbook As IWorkbook)
			...
			Try
				...
				Dim worksheet As Worksheet = workbook.Worksheets(0)
			                ...
			                worksheet("A1:A3").Alignment.Horizontal = DevExpress.Spreadsheet.HorizontalAlignment.Center
			                worksheet("A1:E3").Alignment.Horizontal = DevExpress.Spreadsheet.HorizontalAlignment.Left
			                ...
			                worksheet("B1:E1").Alignment.Horizontal = DevExpress.Spreadsheet.HorizontalAlignment.Center

			                worksheet("B1:E3").Borders.SetAllBorders(Color.Black, BorderLineStyle.Thin)

'				#Region "#CustomNumberFormat"
			                ' Set cell values.
			                worksheet("B2:B3").Value = -15.5
