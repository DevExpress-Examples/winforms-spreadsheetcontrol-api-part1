...
Namespace SpreadsheetControl_API
	Friend Class FormattingActions
        ...
        Public Shared ChangeCellGradientFillAction As Action(Of IWorkbook) = AddressOf ChangeCellGradientFill
...
'				#End Region ' #ColorCells
			...
			End Try
        End Sub
        Shared Sub ChangeCellGradientFill(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
                Dim worksheet As Worksheet = workbook.Worksheets(0)
                ...
                Dim rangeGradient1 As GradientFill = worksheet.Range("C3:H10").Fill.Gradient
                ...
                cellGradient.RectangleLeft = 0.0F
                cellGradient.RectangleRight = 0.0F
                ...
                Dim rangeGradient2 As GradientFill = worksheet.Range("C13:H20").Fill.Gradient
