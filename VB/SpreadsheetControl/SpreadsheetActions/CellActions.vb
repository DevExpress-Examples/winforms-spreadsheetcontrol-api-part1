...
Namespace SpreadsheetControl_API
    Public NotInheritable Class CellActions
        ...
        Public Shared SetValueFromTextAction As Action(Of IWorkbook) = AddressOf SetValueFromText
...
'                #Region "#SimpleRange"
                ...
                Dim rangeC5E7 As Range = worksheet.Range("C5:E7")
...
'                #Region "#ComplexRange"
                Dim rangeA1D4 As Range = worksheet.Range("A1:D4")
                Dim rangeD5E7 As Range = worksheet.Range("D5:E7")
                Dim rangeRow11 As Range = worksheet.Range("11:11")
                Dim rangeF7 As Range = worksheet.Range("F7")
...
'                #End Region ' #CellValue
        ...
        Private Shared Sub SetValueFromText(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
                Dim worksheet As Worksheet = workbook.Worksheets(0)
