...
'#Region "Actions"
        Public AssignActiveWorksheetAction As Action(Of IWorkbook) = AddressOf AssignActiveWorksheet

        Public AddWorksheetAction As Action(Of IWorkbook) = AddressOf AddWorksheet

        Public RemoveWorksheetAction As Action(Of IWorkbook) = AddressOf RemoveWorksheet

        Public RenameWorksheetAction As Action(Of IWorkbook) = AddressOf RenameWorksheet

        Public CopyWorksheetWithinWorkbookAction As Action(Of IWorkbook) = AddressOf CopyWorksheetWithinWorkbook

        Public MoveWorksheetAction As Action(Of IWorkbook) = AddressOf MoveWorksheet

        Public ShowHideWorksheetAction As Action(Of IWorkbook) = AddressOf ShowHideWorksheet

        Public ShowHideGridlinesAction As Action(Of IWorkbook) = AddressOf ShowHideGridlines

        Public ShowHideHeadingsAction As Action(Of IWorkbook) = AddressOf ShowHideHeadings

        Public ZoomWorksheetAction As Action(Of IWorkbook) = AddressOf ZoomWorksheet

'#End Region
        Private Sub AssignActiveWorksheet(ByVal workbook As IWorkbook)
...
'#End Region  ' #ActiveWorksheet
        ...
        Private Sub AddWorksheet(ByVal workbook As IWorkbook)
...
'#End Region  ' #AddWorksheet
        ...
        Private Sub RemoveWorksheet(ByVal workbook As IWorkbook)
...
'#End Region  ' #DeleteWorksheet
        ...
        Private Sub RenameWorksheet(ByVal workbook As IWorkbook)
...
'#End Region  ' #RenameWorksheet
        ...
        Private Sub CopyWorksheetWithinWorkbook(ByVal workbook As IWorkbook)
            workbook.BeginUpdate()
            Try
...
'#End Region  ' #CopyWorksheet
        ...
        Private Sub MoveWorksheet(ByVal workbook As IWorkbook)
...
'#End Region  ' #MoveWorksheet
        ...
        Private Sub ShowHideWorksheet(ByVal workbook As IWorkbook)
...
'#End Region  ' #ShowHideWorksheet
        ...
        Private Sub ShowHideGridlines(ByVal workbook As IWorkbook)
...
'#End Region  ' #ShowHideGridlines
        ...
        Private Sub ShowHideHeadings(ByVal workbook As IWorkbook)
...
'#End Region  ' #ShowHideHeadings
        ...
        Private Sub ZoomWorksheet(ByVal workbook As IWorkbook)
